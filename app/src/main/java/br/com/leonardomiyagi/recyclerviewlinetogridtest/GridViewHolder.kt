 ...
 */
class GridViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), BaseViewHolder {

    constructor(parent: ViewGroup) : this(LayoutInflater.from(parent.context).inflate(R.layout.list_item_grid, parent, false))
